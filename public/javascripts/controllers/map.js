...
wicItApp.controller('MapCtrl', function ($scope, $http, leafletEvents, leafletData, leafletHelpers, leafletMarkersHelpers, NotificationService, GeolocationService, Constants) {
  ...
  var tileUrl = "https://api.mapbox.com/styles/v1/" + mapId + "/cjcjyj9lf1rv52ro3xxncl7pg/tiles/256/{z}/{x}/{y}@2x?access_token=" + mapToken
  ...
  function updateNearbyLocations(event) {
    ...
    locationsUrl += '?sql=SELECT * FROM "ee10b67b-2b93-47e7-aa41-cecfbbd32e17" WHERE "Longitude" between ' + nw.lng + ' and ' + se.lng +
                  ' AND "Latitude" between ' + se.lat + '  and ' + nw.lat;
